...
class App extends Component {
  ...
  setRecommendation() {
    axios
      ...
      .then(
        function (res) {
          console.log("--Recommendation Movie--", res);
      ...
      if (this.state.movieList.length >= 5) {
        return (
          <VideoList
            ...
            callback={this.recevoirCallback.bind(this)}
          />
        );
      }
    };
    return (
      <div className="App">
        ...
        <div className="row">
          ...
          <div className="col-md-4">{verifList()}</div>
        </div>

        <VideoDetail
          title={this.state.currentMovie.title}
          description={this.state.currentMovie.overview}
          date={this.state.currentMovie.release_date}
        />
      </div>
    );
  }
